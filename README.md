...
|---|---|---|
| **macOS** | TestFlight (App Store beta) | [Join the TestFlight beta](https://testflight.apple.com/join/QcgNMdFT). Install the **TestFlight** app from the App Store if you don't have it, open the link, click **Install**. Auto-updates. |
